...
class Face_Register:
    ...
    def GUI_info(self):
        ...
        tk.Label(self.frame_right_info,
                 font=self.font_step_title,
                 text="Step 1: Registration Number").grid(row=7, column=0, columnspan=2, sticky=tk.W, padx=5, pady=20)

        tk.Label(self.frame_right_info, text="Registration Number: ").grid(row=8, column=0, sticky=tk.W, padx=5, pady=0)
